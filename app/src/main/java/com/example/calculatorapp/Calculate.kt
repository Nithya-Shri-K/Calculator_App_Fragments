...
import com.example.calculatorapp.databinding.FragmentCalculateBinding
...
class Calculate : Fragment() {
    ...
    override fun onCreateView(
        ...
        val operation = CalculateArgs.fromBundle(requireArguments()).operation
    ...
    private fun returnResult(operand1 : String, operand2: String, result: Float, operation: Operation){
